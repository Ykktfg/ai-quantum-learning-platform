...
def chat_with_tutor(question: str, quantum_context: dict | None = None) -> str:
    knowledge_context = build_knowledge_context(question, top_k=3)

    quantum_context_text = ""

    if quantum_context:
        normalized_context = build_quantum_context(
            simulation_result=quantum_context.get("simulation"),
            module=quantum_context.get("module"),
            student_level=quantum_context.get("student_level")
        )
...
def explain_circuit(
    ...
    prompt = (
        SYSTEM_PROMPT
        + "\n\n"
        + "Explain the following quantum circuit step by step.\n\n"
        + "Circuit:\n"
        + circuit
        + context_text
        + "\n\n"
...
def debug_quantum_code(
    ...
    prompt = (
        ...
        + "The code has passed deterministic syntax and "
        + "QuantumCircuit validation.\n\n"
        + "Code:\n"
        + code
        + "\n\n"
        + "Reported error:\n"
