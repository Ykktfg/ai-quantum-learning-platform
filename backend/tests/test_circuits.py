...
# ============================================================
# ACTIVITY OWNERSHIP PROTECTION
# ============================================================

def test_activity_ownership_protection():
    ...
    # --------------------------------------------------------
    # User 2 must not receive User 1's activity
    # --------------------------------------------------------

    for activity in activities:

        assert activity["user_id"] != owner_user_id
