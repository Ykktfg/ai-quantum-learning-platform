...
export default function DashboardPage() {
  const stats = [
    ...
    },
    {
      ...
      value: `${student.challengesCompleted}/${student.totalChallenges}`,
      icon: Trophy,
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <GlassCard
        glow="cyan"
        className="relative overflow-hidden p-6 sm:p-8 animate-fade-up"
      >
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {stats.map((s, i) => {
          ...
          return (
            <GlassCard
              key={s.label}
              className="p-4 animate-fade-up sm:p-5"
            >
